      ...
      <div className="p-6 space-y-6 w-full">
        ...
        <div className={`rounded-xl border px-5 py-4 flex items-center justify-between flex-wrap gap-4 ${statusCfg.cls}`}>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {['FA', 'LLD'].includes(doc.type) && ['approved', 'pending'].includes(doc.status) && (
              ...
              <div className="space-y-4">
                ...
                <Card className="border-2 border-primary/10">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    {['FA', 'LLD'].includes(doc.type) && Number(doc.paid_amount) > 0 && (
                      <>
                        <Separator />
                    ...
                    {['FA', 'LLD'].includes(doc.type) && doc.payment_method && (
                      <>
                        <Separator />
