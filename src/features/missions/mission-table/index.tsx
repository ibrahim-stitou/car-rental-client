...
import { useMissionStore } from '@/stores/mision-store';
import { Skeleton } from '@/components/ui/skeleton';
import { Alert, AlertDescription, AlertTitle } from '@/components/ui/alert';
import { AlertCircle } from 'lucide-react';

interface MissionTableParams<TData, TValue> {
  data: TData[];
  totalItems: number;
...
export function MissionTable<TData, TValue>({
  data,
  totalItems,
  columns,
  currentPage,
  ...
  onPageChange,
  onPerPageChange
}: MissionTableParams<TData, TValue>) {
