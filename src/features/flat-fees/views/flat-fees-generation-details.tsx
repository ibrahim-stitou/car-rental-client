...
interface FlatFeesGenerationDetailsViewProps {
  id: string;
}
...
const FlatFeesGenerationDetailsView: React.FC<FlatFeesGenerationDetailsViewProps> = ({ id }) => {
    ...
    const fetchDetails = async () => {
      try {
        const response = await apiClient.get(
          apiRoutes.admin.flatFees.generationDetails(id)
        );
  ...
  return (
    <PageContainer scrollable={false}>
      <div className='flex flex-1 flex-col space-y-4'>
        <Heading
          title={t('admin.flat-fees.generation_details.title')}
          ...
          <Card className='shadow-sm'>
            <CardHeader>
              <CardTitle className='flex items-center gap-2'>
                ...
                {t('admin.flat-fees.generation_details.generation_info')}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className='space-y-2'>
                ...
                <div className='flex justify-between items-center'>
                  <span className='text-muted-foreground flex items-center gap-2'>
                    <Calendar className='w-4 h-4' />
                    {t('admin.flat-fees.generation_details.generation_date')}:
                  </span>
                  <span>
                    {format(parseISO(generation.last_generation_date), 'PPp')}
                  </span>
                </div>
                <div className='flex justify-between items-center'>
                  <span className='text-muted-foreground flex items-center gap-2'>
                    <DollarSign className='w-4 h-4' />
                    {t('admin.flat-fees.table.total_amount')}:
                  </span>
          ...
          <Card className='shadow-sm'>
            <CardHeader>
              <CardTitle className='flex items-center gap-2'>
                ...
                {t('admin.flat-fees.generation_details.generation_counts')}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className='space-y-2'>
                <div className='flex justify-between items-center'>
                  <span className='text-muted-foreground'>
                    {t('admin.flat-fees.generation_details.total_generated')}:
                  </span>
                ...
                <div className='flex justify-between items-center'>
                  <span className='text-muted-foreground'>
                    {t('admin.flat-fees.generation_details.total_skipped')}:
                  </span>
                ...
                <div className='flex justify-between items-center'>
                  <span className='text-muted-foreground'>
                    {t('admin.flat-fees.generation_details.total_errors')}:
                  </span>
                  <Badge
        ...
        <Card className='shadow-sm'>
          <CardHeader>
            <CardTitle className='flex items-center gap-2'>
              ...
              {t('admin.flat-fees.generation_details.consultant_details')}
            </CardTitle>
          </CardHeader>
          <CardContent>
            {consultant_details.length > 0 ? (
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead>{t('admin.flat-fees.consultant_name')}</TableHead>
                    <TableHead>{t('admin.flat-fees.contract_id')}</TableHead>
                    <TableHead>{t('admin.flat-fees.amount')}</TableHead>
                ...
                <TableBody>
                 ...
                 {t('admin.flat-fees.generation_details.no_generated_flat_fees')}
               </div>}
          </CardContent>
        </Card>
      </div>
...
export default FlatFeesGenerationDetailsView;