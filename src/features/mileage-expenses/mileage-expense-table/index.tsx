...
import { useMileageExpenseStore } from '@/stores/mileage-expense-store';
...
export function MileageExpenseTable<TData, TValue>({
  ...
  const { fetchMileageExpenses } = useMileageExpenseStore();
  ...
  if (!loading && data.length === 0) {
    return (
      <div className="py-10 text-center">
        <p className="text-gray-500">No mileage expenses found.</p>
      </div>
    );
  }
