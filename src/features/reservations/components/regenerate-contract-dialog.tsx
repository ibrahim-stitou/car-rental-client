...
export function RegenerateContractDialog({ open, onOpenChange, onConfirm, loading, hasSignature = true, hasStamp = true }: Props) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Un nouveau contrat sera généré à partir des données actuelles de la réservation, avec le cachet et la
            signature de votre compte. L'ancien contrat reste conservé et téléchargeable dans l'historique des
            versions ci-dessous, pour la traçabilité.
          </DialogDescription>
        </DialogHeader>
        ...
        {missingAssets && (
          <Alert className="border-amber-200 bg-amber-50">
            ...
            <AlertDescription className="text-amber-800 text-sm">
              ...
              Le contrat sera régénéré sans, sauf si vous les ajoutez d'abord dans votre{' '}
