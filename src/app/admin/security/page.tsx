...
export default function AdminSecurityPage() {
  ...
  const onSubmit = async (data: AdminPasswordForm) => {
    ...
    try {
      await apiClient.post(apiRoutes.admin.security.updatePassword, {
      ...
      if (error instanceof Error && (error as any)?.response?.data?.errors) {
        ...
        Object.keys(backendErrors).forEach((field) => {
          ...
          if (form.getFieldState(formField as keyof AdminPasswordForm)) {
            form.setError(formField as keyof AdminPasswordForm, {
              type: 'server',
